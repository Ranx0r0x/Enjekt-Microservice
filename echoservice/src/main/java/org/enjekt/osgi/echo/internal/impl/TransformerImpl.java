...
/**
 * The Class TransformerImpl.
 */
public class TransformerImpl implements Transformer{

	/* (non-Javadoc)
	 * @see org.enjekt.osgi.echo.internal.api.Transformer#transform(java.lang.String)
	 */
	@Override
	public EchoRequestMessage transform(String toEcho) {
		return new EchoRequestMessage(toEcho);
	}
